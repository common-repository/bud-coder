...
1. ![new plugin ticket](bud-coder-create.png)
2. ![modify plugin ticket](bud-coder-modify.png)
3. ![settings](bud-coder-settings.png)
4. ![generate code](bud-coder-code-gen.png)
5. ![write to playground](bud-coder-write.png)
